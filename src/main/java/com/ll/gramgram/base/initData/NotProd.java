    ...
    CommandLineRunner initData(
        ...
        return new CommandLineRunner() {
            ...
            public void run(String... args) throws Exception {
                ...
                Member memberUser6ByKakao = memberService.whenSocialLogin("KAKAO", "KAKAO__2733218627").getData();
                Member memberUser7ByGoogle = memberService.whenSocialLogin("GOOGLE", "GOOGLE__114181339834665453705").getData();
                Member memberUser8ByNaver = memberService.whenSocialLogin("NAVER", "NAVER__1xEbNDznbNKwmjZqIFX930MCaU747_z44NnWcuHtL_I").getData();
                Member memberUser9ByFacebook = memberService.whenSocialLogin("FACEBOOK", "FACEBOOK__2215724828624549").getData();
                ...
                LikeablePerson likeablePersonToinstaUser5 = likeablePersonService.like(memberUser3, "yjs96321", 1).getData();
                Ut.reflection.setFieldValue(likeablePersonToinstaUser5, "modifyUnlockDate", LocalDateTime.now().minusSeconds(1));
                LikeablePerson likeablePersonToinstaUser6 = likeablePersonService.like(memberUser3, "yjs96321", 2).getData();
            }
        };
    }
}
